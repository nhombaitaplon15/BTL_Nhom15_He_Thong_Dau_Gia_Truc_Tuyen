...
public class ItemService {
    ...
    static {
        ...
        Items electronics = new Electronics(25,"Đồng hồ Romain Jerome Super Mario Bros","Romain Jerome",18950,"Chiếc đồng hồ có đường kính 46mm và được làm bằng chất liệu titan màu đen." +
