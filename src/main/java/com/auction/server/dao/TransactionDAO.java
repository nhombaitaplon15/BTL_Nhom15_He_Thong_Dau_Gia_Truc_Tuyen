...
public class TransactionDAO {
    ...
    public boolean createTransaction(Connection conn, int userId, double amount, String type) throws SQLException {
        String sql = "INSERT INTO transactions (user_id, amount, type, created_at) VALUES (?, ?, ?, NOW())";
