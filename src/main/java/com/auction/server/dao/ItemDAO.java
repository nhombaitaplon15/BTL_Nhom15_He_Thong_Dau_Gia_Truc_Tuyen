...
public class ItemDAO {
    ...
    // 🎯 SỬA: Sắp xếp lại chuẩn xác 100% vị trí Index theo DDL thực tế của PostgreSQL
    public int insertItem(Connection conn, Item item) throws SQLException {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            // Làm sạch các ô từ 7 tới 20 về NULL mặc định để tránh lỗi ghi đè rác dữ liệu
            for (int i = 7; i <= 20; i++) {
                ps.setNull(i, Types.NULL);
            }

            // Gán giá trị đặc thù dựa trên cấu trúc mô hình thừa kế đa hình Single Table
            if (item instanceof Electronics e) {
                ...
                // ✨ SỬA CHÍ TRỌNG: Gán chuỗi dạng chữ ("true"/"false") để khớp kiểu dữ liệu TEXT trong DB của bạn
            ...
            // Gán các trường nằm cuối bảng (19: img_item, 20: license_plate)
